"""
This file contains utility functions for preparing the dataset for the conditional multitask segmentation model (delineation).
"""

import numpy as np
import cv2

def get_boundary_label(label, kernel_size=(12, 12)):
